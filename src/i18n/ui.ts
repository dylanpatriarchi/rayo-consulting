...
export const ui = {
	en: {
		...
		"contact.subtitle":
			"Let's weave digital dreams together, one pixel at a time",
		"contact.name": "Name",
		"contact.email": "Email",
	...
	it: {
		...
		"hero.title.main": "Realizziamo",
		"hero.title.1": "siti web",
		"hero.title.2": "web app",
		...
		"projects.title": "I nostri lavori",
